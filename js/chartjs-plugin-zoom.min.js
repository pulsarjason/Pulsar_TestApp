!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : ((e = "undefined" != typeof globalThis ? globalThis : e || self).ChartZoom = t(e.Chart, e.Hammer, e.Chart.helpers));
})(this, function (e, t, n) {
  "use strict";
  function o(e) {
  ...
  function l(e, t, n) {
    return (
      void 0 === e ||
      ("string" == typeof e ? -1 !== e.indexOf(t) : "function" == typeof e && -1 !== e({ chart: n }).indexOf(t))
    );
  }
  function s(e, t) {
    return (
      "function" == typeof e && (e = e({ chart: t })),
      "string" == typeof e ? { x: -1 !== e.indexOf("x"), y: -1 !== e.indexOf("y") } : { x: !1, y: !1 }
    );
  }
  function u(e, t, o) {
    ...
    if (c) {
      const e = s(c, o);
      for (const t of ["x", "y"]) e[t] && ((u[t] = l[t]), (l[t] = !1));
    }
  ...
  function h(e, { min: t, max: n }, o, a = !1) {
    const i = d(e.chart),
      ...
      h = Math.max(t, m),
      g = Math.min(n, f),
      x = a ? Math.max(g - h, u) : e.max - e.min;
    if (g - h !== x)
      if (m > g - x) (t = h), (n = h + x);
      else if (f < h + x) (n = g), (t = g - x);
      else {
        const e = (x - g + h) / 2;
        (t = h - e), (n = g + e);
      }
  ...
  const g = (e) => (0 === e || isNaN(e) ? 0 : e < 0 ? Math.min(Math.round(e), -1) : Math.max(Math.round(e), 1));
  const x = {
    second: 500,
    minute: 3e4,
    hour: 18e5,
  ...
  function y(e, t, n, o = !1) {
    const { min: a, max: i, options: c } = e,
      ...
      u = e.getValueForPixel(e.getPixelForValue(i + l) - t),
      { min: m = -1 / 0, max: d = 1 / 0 } = (o && n && n[e.axis]) || {};
    return !!(isNaN(s) || isNaN(u) || s < m || u > d) || h(e, { min: s, max: u }, n, o);
  }
  function b(e, t, n) {
    return y(e, t, n, !0);
  }
  const v = {
      category: function (e, t, n, o) {
        ...
        return (
          ...
          h(e, { min: e.min + g(a.min), max: e.max - g(a.max) }, o, !0)
        );
      },
    ...
    z = {
      category: function (e, t, n) {
        ...
        return (
          t < -r
            ? ((i = Math.min(i + l, o)), (a = 1 === c ? i : i - c), (s = i === o))
            : t > r && ((a = Math.max(0, a - l)), (i = 1 === c ? a : a + c), (s = 0 === a)),
          h(e, { min: a, max: i }, n) || s
        );
      },
      default: y,
    ...
    return (
      n.each(o, function (e) {
        (function (e, t, n) {
          ...
          (a[e.id] = { min: { scale: e.min, options: e.options.min }, max: { scale: e.max, options: e.options.max } });
      }),
      M(a, o),
      M(i, o),
      a
  ...
  function j(e, t, o = "none") {
    ...
    n.each(p || e.scales, function (e) {
      e.isHorizontal() && m ? S(e, a, c, l) : !e.isHorizontal() && f && S(e, i, c, l);
    }),
      e.update(o),
      n.callback(s.onZoom, [{ chart: e }]);
  }
  function C(e, t, o, a = "none") {
    const i = d(e),
      {
  ...
  function R(e, t, o, a = "none") {
    ...
    n.each(o || e.scales, function (e) {
      e.isHorizontal() && m ? Z(e, i, s, r) : !e.isHorizontal() && f && Z(e, c, s, r);
    }),
      e.update(a),
  ...
  function X(e, t) {
    ...
    n.dragStart &&
      "Escape" === t.key &&
      (L(e, "keydown"), (n.dragging = !1), (n.dragStart = n.dragEnd = null), e.update("none"));
  }
  function F(e, t, o) {
    ...
    if (a) {
      ...
      if (!1 === n.callback(a, [{ chart: e, event: t, point: r }])) return n.callback(i, [{ chart: e, event: t }]), !1;
    }
  }
  function H(e, t) {
    const o = d(e),
      { pan: a, zoom: l = {} } = o.options;
    if (0 !== t.button || c(i(a), t) || r(i(l.drag), t)) return n.callback(l.onZoomRejected, [{ chart: e, event: t }]);
    !1 !== F(e, t, l) && ((o.dragStart = t), Y(e, e.canvas, "mousemove", E), Y(e, window.document, "keydown", X));
  }
  function V(e, t, n, o) {
    const { left: a, top: i } = n.target.getBoundingClientRect(),
      c = l(t, "x", e),
      r = l(t, "y", e);
    let { top: s, left: u, right: m, bottom: d, width: f, height: p } = e.chartArea;
    c && ((u = Math.min(n.clientX, o.clientX) - a), (m = Math.max(n.clientX, o.clientX) - a)),
      r && ((s = Math.min(n.clientY, o.clientY) - i), (d = Math.max(n.clientY, o.clientY) - i));
    const h = m - u,
      g = d - s;
    return {
      left: u,
  ...
  function B(e, t) {
    ...
    const {
      ...
      r = V(e, a, o.dragStart, t),
      s = l(a, "x", e) ? r.width : 0,
      u = l(a, "y", e) ? r.height : 0,
      m = Math.sqrt(s * s + u * u);
    if (((o.dragStart = o.dragEnd = null), m <= c)) return (o.dragging = !1), void e.update("none");
    C(e, { x: r.left, y: r.top }, { x: r.right, y: r.bottom }, "zoom"),
  ...
  function K(e, t) {
    ...
    if (
      !(function (e, t, o) {
        if (r(i(o.wheel), t)) n.callback(o.onZoomRejected, [{ chart: e, event: t }]);
        else if (!1 !== F(e, t, o) && (t.cancelable && t.preventDefault(), void 0 !== t.deltaY)) return !0;
      })(e, t, a)
    )
      return;
    const c = t.target.getBoundingClientRect(),
      l = 1 + (t.deltaY >= 0 ? -a.wheel.speed : a.wheel.speed);
    j(e, { x: l, y: l, focalPoint: { x: t.clientX - c.left, y: t.clientY - c.top } }), o && o();
  }
  function N(e, t, o, a) {
    o &&
  ...
  function q(e, t) {
    return function (o, a) {
      ...
      return (
        !u ||
        !(!t.panning && "mouse" === a.pointerType && (r(i(l), u) || c(i(s.drag), u))) ||
      ...
      const { center: o, pointers: a } = n,
        ...
        r = (function (e, t) {
          const n = Math.abs(e.clientX - t.clientX),
            ...
            a = n / o;
          let i, c;
          return a > 0.3 && a < 1.7 ? (i = c = !0) : n > o ? (i = !0) : (c = !0), { x: i, y: c };
        })(a[0], a[1]),
  ...
  function A(e, t, n) {
    ...
    o &&
      ((t.panning = !0),
      R(e, { x: n.deltaX - o.x, y: n.deltaY - o.y }, t.panScales),
  ...
  function U(e, t) {
    ...
    r &&
      ...
      l.on("pinch", (t) => W(e, o, t)),
      l.on("pinchend", (t) =>
        (function (e, t, o) {
          t.scale && (W(e, t, o), (t.scale = null), n.callback(t.options.zoom.onZoomComplete, [{ chart: e }]));
        })(e, o, t)
      )),
      c &&
        c.enabled &&
        (l.add(new a.default.Pan({ threshold: c.threshold, enable: q(e, o) })),
        l.on("panstart", (t) =>
          (function (e, t, o) {
            const { enabled: a, onPanStart: i, onPanRejected: c } = t.options.pan;
            if (!a) return;
            const r = o.target.getBoundingClientRect(),
              l = { x: o.center.x - r.left, y: o.center.y - r.top };
            if (!1 === n.callback(i, [{ chart: e, event: o, point: l }])) return n.callback(c, [{ chart: e, event: o }]);
            (t.panScales = u(t.options.pan, l, e)), (t.delta = { x: 0, y: 0 }), clearTimeout(t.panEndTimeout), A(e, t, o);
          })(e, o, t)
        ),
        l.on("panmove", (t) => A(e, o, t)),
        l.on("panend", () =>
          (function (e, t) {
            (t.delta = null),
              t.panning &&
  ...
  function G(e, t, n) {
    ...
    const { left: c, top: r, width: l, height: s } = V(e, n.zoom.mode, a, i),
      u = e.ctx;
    u.save(),
      u.beginPath(),
      ...
      u.fillRect(c, r, l, s),
      o.borderWidth > 0 &&
        ((u.lineWidth = o.borderWidth), (u.strokeStyle = o.borderColor || "rgba(225,225,225)"), u.strokeRect(c, r, l, s)),
      u.restore();
  }
  var J = {
    id: "zoom",
    ...
    start: function (e, t, o) {
      (d(e).options = o),
        ...
        a.default && U(e, o),
        (e.pan = (t, n, o) => R(e, t, n, o)),
        (e.zoom = (t, n) => j(e, t, n)),
        (e.zoomRect = (t, n, o) => C(e, t, n, o)),
        (e.zoomScale = (t, n, o) =>
    ...
    beforeUpdate: function (e, t, n) {
      (d(e).options = n),
        (function (e, t) {
          ...
          o.enabled ? (Y(e, n, "wheel", K), N(e, "onZoomComplete", i, 250)) : L(e, "wheel"),
            a.enabled
              ? (Y(e, n, "mousedown", H), Y(e, n.ownerDocument, "mouseup", B))
              : (L(e, "mousedown"), L(e, "mousemove"), L(e, "mouseup"), L(e, "keydown"));
        })(e, n);
    },
