  ...
  Imp.prototype = {
      ...
      t.jqi[opts.show](opts.promptspeed, function () {
        t.goToState(
          isNaN(opts.initialState)
            ? opts.initialState
            : t.jqi
                .find("." + opts.prefix + "states ." + opts.prefix + "state")
    ...
    addState: function (statename, stateobj, afterState) {
      ...
      for (i = 0, l = buttons.length; i < l; i++) {
        (v = buttons[i]),
          (defbtn =
            stateobj.focus === i || (isNaN(stateobj.focus) && stateobj.defaultButton === i)
              ? opts.prefix + "defaultbutton " + opts.classes.defaultButton
              : "");
