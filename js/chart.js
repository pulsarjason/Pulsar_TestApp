!(function (t, e) {
  ...
  function me(t, e, i) {
    let s;
    return (
      "string" == typeof t ? ((s = parseInt(t, 10)), -1 !== t.indexOf("%") && (s = (s / 100) * e.parentNode[i])) : (s = t), s
    );
  }
      ...
      ? (function (t, e, i, s) {
          ...
          for (const t of e) {
            ...
            for (u = d + 1; u <= t.end; u++) {
              ...
              (e = ji(
                s.setContext(
                  Ye(n, { type: "segment", p0: o, p1: r, p0DataIndex: (u - 1) % l, p1DataIndex: u % l, datasetIndex: a })
                )
              )),
  ...
  function Es(t, e, i) {
    ...
    if (
      !(
        i &&
        ((l =
          1 === s ? Math.max(h - o, a - h) : 0 === e ? (t.getPixelForTick(1) - h) / 2 : (h - t.getPixelForTick(n - 1)) / 2),
        (h += n < e ? l : -l),
        h < o - r || h > a + r)
      )
    )
    ...
    buildOrUpdateControllers() {
      ...
      for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
        ...
        if (
          ...
          Object.assign(e.prototype, { dataElementType: Ws.getElement(a), datasetElementType: s && Ws.getElement(s) }),
      ...
      let { start: a, count: r } = (function (t, e, i) {
        ...
        if (t._sorted) {
          ...
          d && (n = jt(Math.min(re(r, a.axis, h).lo, i ? s : re(e, l, a.getPixelForValue(h)).lo), 0, s - 1)),
            (o = u
              ? jt(Math.max(re(r, a.axis, c).hi + 1, i ? 0 : re(e, l, a.getPixelForValue(c)).hi + 1), n, s) - n
              : s - n);
        }
    ...
    Un && !e.options.segment
      ...
      : (function (t, e, i, s) {
          const { segments: n, options: o } = e,
            a = Yn(e);
          for (const r of n)
            Wn(t, o, r.style), t.beginPath(), a(t, e, r, { start: i, end: i + s - 1 }) && t.closePath(), t.stroke();
        })(t, e, i, s);
  }
  class qn extends Ds {
    constructor(t) {
  ...
  class so extends Ds {
    ...
    draw(t) {
      ...
      t.save(),
        (o.w === n.w && o.h === n.h) ||
          (t.beginPath(), a(t, io(o, e, n)), t.clip(), a(t, io(n, -e, o)), (t.fillStyle = i), t.fill("evenodd")),
        t.beginPath(),
        a(t, io(n, e)),
        (t.fillStyle = s),
        t.fill(),
  ...
  (so.id = "bar"),
    (so.defaults = { borderSkipped: "start", borderWidth: 0, borderRadius: 0, inflateAmount: "auto", pointStyle: void 0 }),
    ...
    return (t.scale || {}).getPointPositionForValue
      ? (function (t) {
          ...
          if (((c = "start" === i ? a : "end" === i ? r : U(i) ? i.value : e.getBaseValue()), s.grid.circular))
            return (
              (h = e.getPointPositionForValue(0, a)), new ho({ x: h.x, y: h.y, radius: e.getDistanceFromCenterForValue(c) })
            );
        ...
        !(function (t, e, i) {
          ...
          if (
            ...
            const o = e + Math.max((f - x) / 2, 0),
              ...
              r = We(i.borderRadius);
            s.beginPath(),
              Object.values(r).some((t) => 0 !== t) ? oe(s, { x: a, y: o, w: m, h: x, radius: r }) : s.rect(a, o, m, x),
              s.fill(),
              0 !== n && s.stroke();
          }
          s.restore();
  ...
  function Fo(t, e) {
    ...
    if (
      ...
      p +=
        f * (e.displayColors ? Math.max(r, l.lineHeight) : l.lineHeight) + (x - f) * l.lineHeight + (x - 1) * e.bodySpacing;
    }
    ...
    buildTicks() {
      ...
      const s = (function (t, e) {
        ...
        for (
          m &&
          (d && v !== o
            ? (i.push({ value: o }), v < o && P++, Lt(Math.round((v + P * k) * y) / y, o, Ko(o, _, t)) && P++)
            : v < o && P++);
          P < M;
          ++P
        )
