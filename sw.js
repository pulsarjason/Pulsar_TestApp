  ...
  e.waitUntil(
    caches.open("web-app-offline").then(function (cache) {
      return cache.addAll([
        ...
        "./img/pulsarlogo.svg",
        "./img/pulsarlogo_amber.svg",
        "./img/pulsarlogo_blue.svg",
        "./img/pulsarlogo_green.svg",
        "./img/pulsarlogo_off.svg",
        "./img/pulsarlogo_purple.svg",
        "./img/pulsarlogo_red.svg",
        "./img/pulsarlogo_teal.svg",
        "./img/pulsarlogo_white.svg",
